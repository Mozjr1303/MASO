...
@section('title', 'Maso Awards - Nominate')

@section('og-tags')
    <meta property="og:url" content="https://www.maso-awards.com/nominate" />
...
<div class="categories row d-flex justify-content-center">
    ...
    <div class="col-lg-3 col-md-4 col-sm-6 col-6 wow fadeInUp" data-wow-duration="0.3s" data-wow-delay="0.2s">
        <a href="{{ url('nominate/category/'. $category->id.'/'. $category->hiphen) }}" target="_blank" class="black">
