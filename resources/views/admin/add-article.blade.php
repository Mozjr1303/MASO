...
@section('title', 'Maso Awards - Add Article')
                    ...
                    <div class="white_box mb_30">
                        ...
                        <form action="{{ route('admin.add-article') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="details" id="details" cols="30" rows="10" class="form-control" placeholder="Enter Article Details">{{ old('details') }}</textarea>
                            </div>
                            <div class="d-flex justify-content-center">
                                <button type="submit" class="form-btn"><i class="fa fa-newspaper"></i> Submit</button>
                            </div>
                        </form>
                    </div>
                </div>
