...
@section('title', 'Maso Awards - Add Promoter')
                    ...
                    <div class="white_box mb_30">
                        <div class="box_header ">
                            <div class="main-title">
                                <h3 class="mb-0">Add Promoter</h3>
                            </div>
                        </div>
                        <form action="{{ route('admin.add-promoter') }}" method="POST">
                            @csrf
                            <div class="mb-3">
                                <label class="form-label" for="name">Full Name</label>
                                <input type="text" name="name" id="name" class="form-control"
                                    placeholder="Enter Promoter Name" value="{{ old('name') }}" required>
                            </div>
                            <div class="mb-3">
