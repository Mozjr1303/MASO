...
<head>
    ...
    <link rel="stylesheet" href="{{ url('frontend/css/main.css?v=1') }}">
...
<body>
        ...
        <div class="container-fluid container-xxl d-flex align-items-center">
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    ...
                    <li><a class="nav-link scrollto active" href="/vote">Categories</a></li>
    ...
    <script src="{{ url('frontend/js/fp.min.js') }}"></script>
    @yield('vote-js')
    @yield('ticket-js')
    
    <!-- Template Main JS File -->
    <script src="{{ url('frontend/js/all.min.js') }}"></script>
    <script src="{{ url('frontend/assets/js/main.js?v=1') }}"></script>
